...
public class EstadisticaService implements IEstadisticaService {
  ...
  @Autowired
  public EstadisticaService(IAgregadorService agregadorService, IColeccionRepository coleccionRepository, ISolicitudRepository solicitudRepo, ICategoriaRepository categoriaRepo, IDetectorDeSpam detectorDeSpam, IEstadisticaRepository estadisticaRepository, IFuenteRepository fuenteRepository) {
